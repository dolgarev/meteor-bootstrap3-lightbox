export const Lightbox = (($) => {
    ...
    showArrowsOnVideo: false,
    showArrowsOnRemoteContent: false,
	...
	class Lightbox {
      ...
      let description = `<div class="ekko-lightbox-description">${this._config.description || ''}</div>`;
      let sub = `<div class="ekko-lightbox-sub">${this._config.sub || ''}</div>`;
      ...
      const sub = this._$element.data('sub') || ''
      const $sub = this._$modalBody.find('.ekko-lightbox-sub')
      if (sub) {
        $sub.text(sub).show()
      } else {
        $sub.hide()
      ...
      const description = this._$element.data('description') || ''
      const $description = this._$modalBody.find('.ekko-lightbox-description')
      if (description) {
		...
		_showInstagramVideo(id, $containerForElement) {
			...
			if (this._$modalArrows && this._config.showArrowsOnVideo === false) //hide the arrows when showing video
		...
		_showVideoIframe(url, width, height, $containerForElement) { // should be used for videos only. for remote content use loadRemoteContent (data-type=url)
			...
			this._resize(width, height);
			this._config.onContentLoaded.call(this);
			if (this._$modalArrows && this._config.showArrowsOnVideo === false)
		...
		_loadRemoteContent(url, $containerForElement) {
			...
			if (this._$modalArrows && this._config.showArrowsOnRemoteContent === false) //hide the arrows when remote content
				this._$modalArrows.css('display', 'none')
